...
OUTPUT_SUBDIR = "nonlinear_only_n44_r6"
...
def build_stage2_nonlinear_only_config(
    *,
...
def run_stage2_nonlinear_only(config: ExperimentConfig | None = None) -> object:
