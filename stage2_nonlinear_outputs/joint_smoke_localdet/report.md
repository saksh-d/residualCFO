...
- Output directory: `/Users/saksh/Documents/Local Documents/ibm/ofdm/residualCFO/idea3_stage2_awgn/stage2_nonlinear_outputs/joint_smoke_localdet`
- Modulation: `16QAM`
...
- Output dir: `/Users/saksh/Documents/Local Documents/ibm/ofdm/residualCFO/idea3_stage2_awgn/stage2_nonlinear_outputs/joint_smoke_localdet`
...
- Detector-first stage: epochs `35`, lr `0.001`, freeze `W` and `V`
- Reopen-V stage: enabled `True`, require detector win `True`, gain tolerance `0.0`, epochs `25`, lr `0.0005`
...
- NonlinearOnly: best epoch `1`, val total `4.2284e+00`, val BER `2.4826e-02`, hard-CFO weighted BER `6.9770e-02`, residual scale `0.1000`, clean identity `1.6871e-03`, clean leakage `1.4529e-03`.
- ReopenV: best epoch `45`, val total `4.2111e+00`, val BER `2.5781e-02`, hard-CFO weighted BER `7.1966e-02`, residual scale `0.1004`, clean identity `1.5108e-03`, clean leakage `1.4364e-03`.
- Learned BER at CFO `0.00`: linear `1.519e-04` vs nonlinear `2.604e-04` (delta `+1.085e-04`).
- Learned BER at CFO `0.05`: linear `9.592e-03` vs nonlinear `9.679e-03` (delta `+8.681e-05`).
- Learned BER at CFO `0.10`: linear `1.025e-01` vs nonlinear `1.022e-01` (delta `-2.387e-04`).
- Stage 2 did not beat `stage1_linear` at CFO `0.05`.
- Stage 2 beat `stage1_linear` at CFO `0.10`.
- Stage 2 regressed at zero CFO.
- Against the classical baseline at CFO `0.10`: learned linear `1.025e-01`, learned nonlinear `1.022e-01`, OFDM `1.056e-01`.
- Learned robustness window BER <= `0.01`: linear `|delta|<=0.040` vs nonlinear `|delta|<=0.040`.
- Learned EVM at CFO `0.10`: linear `0.3783` vs nonlinear `0.3791`.
