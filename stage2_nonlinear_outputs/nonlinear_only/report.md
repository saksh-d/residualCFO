...
- Output directory: `/Users/saksh/Documents/Local Documents/ibm/ofdm/residualCFO/idea3_stage2_awgn/stage2_nonlinear_outputs/nonlinear_only`
- Modulation: `16QAM`
...
- Output dir: `/Users/saksh/Documents/Local Documents/ibm/ofdm/residualCFO/idea3_stage2_awgn/stage2_nonlinear_outputs/nonlinear_only`
...
- Nonlinear-only stage: epochs `4`, lr `0.001`, freeze `W` and `V`
...
- NonlinearOnly: best epoch `4`, val total `2.0419e+00`, val BER `3.2118e-02`, hard-CFO weighted BER `7.1510e-02`, residual scale `0.1002`, clean identity `2.1680e-03`, clean leakage `2.1428e-03`.
- Learned BER at CFO `0.10`: linear `1.015e-01` vs nonlinear `1.022e-01`.
- Stage 2 did not beat `stage1_linear` at CFO `0.10`; the nonlinear branch underperformed there.
- Against the classical baseline at CFO `0.10`: learned linear `1.015e-01`, learned nonlinear `1.022e-01`, OFDM `1.044e-01`.
- Learned robustness window BER <= `0.01`: linear `|delta|<=0.000` vs nonlinear `|delta|<=0.000`.
- Learned EVM at CFO `0.10`: linear `0.3786` vs nonlinear `0.3786`.
- Learned spectral check: OOB linear `1.5326e-02`, nonlinear `1.5326e-02`.
