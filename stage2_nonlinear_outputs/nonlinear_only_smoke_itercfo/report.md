...
- Output directory: `/Users/saksh/Documents/Local Documents/ibm/ofdm/residualCFO/idea3_stage2_awgn/stage2_nonlinear_outputs/nonlinear_only_smoke_itercfo`
- Modulation: `16QAM`
...
- Output dir: `/Users/saksh/Documents/Local Documents/ibm/ofdm/residualCFO/idea3_stage2_awgn/stage2_nonlinear_outputs/nonlinear_only_smoke_itercfo`
...
- Nonlinear-only stage: epochs `60`, lr `0.001`, freeze `W` and `V`
...
- NonlinearOnly: best epoch `1`, val total `4.3495e+00`, val BER `2.5087e-02`, hard-CFO weighted BER `7.0445e-02`, residual scale `0.1000`, cancellation scale `0.1000`, eps-hat MAE `4.5202e-02`, clean identity `1.6871e-03`, clean leakage `1.4529e-03`.
...
- Learned BER at CFO `0.10`: linear `1.025e-01` vs nonlinear `1.026e-01` (delta `+8.681e-05`).
...
- Against the classical baseline at CFO `0.10`: learned linear `1.025e-01`, learned nonlinear `1.026e-01`, OFDM `1.056e-01`.
